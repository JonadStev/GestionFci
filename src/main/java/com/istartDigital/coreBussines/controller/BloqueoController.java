...
public class BloqueoController {
    ...
    public ReporteCuentasBaneadasPorFechaDto getBloqueosByFecha(@RequestParam(name = "fechaDesde") String fechaDesde, @RequestParam(name = "fechaHasta") String fechaHasta){
        return bloqueoService.getCuentasBaneadasByFecha(fechaDesde,fechaHasta);
    }

    @GetMapping("/bloqueos/generales")
    public Integer[] getBloqueosGenerales(){
        return bloqueoService.getCuentasGenerales();
    }
